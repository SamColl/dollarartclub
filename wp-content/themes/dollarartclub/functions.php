<?php
/**
 * Dollar Art Club functions and definitions
 *
...
if ( ! function_exists( 'dollar_art_club_setup' ) ) :
	/**
	 ...
	 */
	function dollar_art_club_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Dollar Art Club, use a find and replace
		 * to change 'dollar-art-club' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'dollar-art-club', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'dollar-art-club' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'dollar_art_club_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'dollar_art_club_setup' );
 ...
 */
function dollar_art_club_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'dollar_art_club_content_width', 640 );
}
add_action( 'after_setup_theme', 'dollar_art_club_content_width', 0 );
 ...
 */
function dollar_art_club_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'dollar-art-club' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'dollar-art-club' ),
...
add_action( 'widgets_init', 'dollar_art_club_widgets_init' );
...
function dollar_art_club_scripts() {
  ...
  wp_enqueue_script( 'jquery' );
	...
	wp_enqueue_script( 'dac-javascript', get_template_directory_uri() . '/dac.js', array(), true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'dollar_art_club_scripts' );
